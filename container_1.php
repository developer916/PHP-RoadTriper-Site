	...
	<div id="locationInfoContainer" class='popupContainer <?php if( $pageType != "locations" && $pageType != "news" && $pageType != "eye") echo "hide";?>'>
		<div id="locationInfo" itemscope itemtype="http://schema.org/Place">
			...
			<div>
				...
				<div id="locationInfoImage" style="background-image: url(<?php echo $dataResult['ua_location_photo'];?>); background-size: cover; background-position: 50% 50%; background-repeat: no-repeat no-repeat;">
				...
				<button class="btn btn-danger btn-small floatleft" id="btnLocationUpToTop" onclick="fnLocationUpToTop(this)" style="outline: none; width: 45px; height: 45px; background: transparent; border: none;"></button>
				</div>
				...
				<div id="locationInfoComment">
					...
					<textarea id="locationInfoCommentText" rows="3" placeholder="<? echo _lang('Got a trip/review/awesome factoid about this place? Please share!');?>"></textarea>
