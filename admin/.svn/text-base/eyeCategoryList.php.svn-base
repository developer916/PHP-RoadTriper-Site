...
<head>
    ...
    <script src="/js/admin/eyeCategoryList.js"></script>
</head>
<body>
   <div id="container">
		...
		<div id="content" class="floatleft">
			...
			<div id="divContent">
				<div id="divActionButton" style="float:right;margin-bottom:20px;">
				    <a href = "eyeCategoryDetail.php" class="btn btn-primary"><?php echo _lang("Add");?></a>
					<a class="btn btn-danger" onclick="onDeleteEyeCategory()"><?php echo _lang("Delete");?></a>
				</div>
				...
				<table class="table table-striped table-bordered table-hover" id="example">
					<thead>
						<tr>
							...
							<th><?php echo _lang("Eye Category Title");?></th>
							<th><?php echo _lang("Eye Categgory Image");?></th>
							<th><?php echo _lang("Eye Categgory Marker");?></th>							
					...
					<tbody>
						...
						{
							echo "<tr>";
							echo "   <td><input type='checkbox' value='".$result[$i]['ua_eye_category']."'/></td>";
							echo "   <td><a href='eyeCategoryDetail.php?id=".$result[$i]['ua_eye_category']."'>".($i + 1)."</a></td>";
							echo "   <td style='width:45%'><a href='eyeCategoryDetail.php?id=".$result[$i]['ua_eye_category']."'>".$result[$i]['ua_title']."</td>";
