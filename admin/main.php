...
<body>
	<div id="container">
		...
		<div id="content" class="floatleft">
			<h3 class="pageHeader">Сорри, что все на англ. Так удобнее. Выбирайте NEWS MANAGEMENT слева. Затем нажимаем ADD. Ничего не удаляйете. А то потом кто-то обидется)</h3>
		</div>		
